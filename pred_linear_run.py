...
from pred_linear_analyse import make_inputs_for_analysis
from pred_linear_analyse import analyse_all
from pred_linear_analyse import make_csv_from_results
from pred_linear_analyse import read_prediction_results
...
mhci_alleles = ['HLA-A*02:01', 'HLA-C*07:01', 'HLA-A*01:01', 'HLA-A*03:01', 'HLA-C*07:02', 'HLA-C*04:01', 'HLA-B*44:02', 'HLA-B*07:02', 'HLA-B*08:01', 'HLA-C*05:01', 'HLA-C*03:04',
                'HLA-C*06:02', 'HLA-A*11:01', 'HLA-B*40:01', 'HLA-A*24:02', 'HLA-B*35:01', 'HLA-C*03:03', 'HLA-B*51:01', 'HLA-C*12:03', 'HLA-B*15:01', 'HLA-C*01:02', 'HLA-A*33:03',
                'HLA-A*23:01', 'HLA-C*02:02', 'HLA-B*53:01', 'HLA-C*08:01']
...
analysis_input = make_inputs_for_analysis()
print("Analysing sequences...")
analysis_results = analyse_all(analysis_input)
make_csv_from_results(analysis_results)
